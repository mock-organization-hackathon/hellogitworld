...
This project includes unit tests to verify the application behaves correctly:

* `AppTest.testHelloWorldOutput()` - Verifies that the main method prints "Hello World!" to standard output
* `AppTest.testApp()` - Basic test case

Run tests using your preferred build tool (Maven/Gradle) with the test command.
